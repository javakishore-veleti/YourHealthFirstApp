...
#
# Usage:
#   chmod +x gcp-healthcare-ui-cloud-run-setup.sh
#   ./gcp-healthcare-ui-cloud-run-setup.sh
#############################################################################
...
if gcloud iam service-accounts describe "${SERVICE_ACCOUNT_NAME}@${PROJECT_ID}.iam.gserviceaccount.com" &>/dev/null; then
    ...
    gcloud iam service-accounts create $SERVICE_ACCOUNT_NAME \
        ...
        --description="Service account for deploying Healthcare Plans UI to Cloud Run"
...
if gcloud artifacts repositories describe $ARTIFACT_REPO_NAME --location=$REGION &>/dev/null; then
    ...
    gcloud artifacts repositories create $ARTIFACT_REPO_NAME \
        ...
        --location=$REGION \
        --description="Docker images for Healthcare Plans UI Angular application"
...
# Get Project Number for the principal
...
if [[ "$CREATE_KEY" == "y" || "$CREATE_KEY" == "Y" ]]; then
    KEY_FILE="gcp-healthcare-ui-sa-key.json"
    ...
    echo "    - Delete the local file after adding to GitHub Secrets"
    echo "    - Consider using Workload Identity instead (more secure)"
fi
...
echo ""
echo "  1. gcp-healthcare-ui-cloud-run-deploy.yml      - Deploy service"
echo "  2. gcp-healthcare-ui-cloud-run-stop.yml        - Stop service"
echo "  3. gcp-healthcare-ui-cloud-run-restart.yml     - Restart service"
echo "  4. gcp-healthcare-ui-cloud-run-health-check.yml - Check health"
echo "  5. gcp-healthcare-ui-cloud-run-destroy.yml     - Delete service"
echo "  6. gcp-healthcare-ui-cloud-run-status.yml      - View all services"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔗 Useful Links"
echo ""
